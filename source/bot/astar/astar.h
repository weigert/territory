...
{
  voxel::block TOP = world->get(ivec3(x,y,z));
  voxel::block BOTTOM = world->get(ivec3(x,y-1,z));
  if(BOTTOM == voxel::BLOCK_AIR) return 10;
  if(TOP != voxel::BLOCK_AIR) return 10;
  return 1;
  //if(TOP == voxel::BLOCK_AIR && BOTTOM == voxel::BLOCK_AIR) return 10;
  //if()
  //return ((== voxel::BLOCK_AIR)?1:10) + 9 - ((world->get(ivec3(x,y-1,z)) == voxel::BLOCK_AIR)?1:10);
}
